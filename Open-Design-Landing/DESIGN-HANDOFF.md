# 61c261d0-5655-49eb-829a-04c541171406 implementation handoff
...
- `index.html`
- `logo-options.html`
- `open-finance-atelier-landing.html`
...
- `assets/method-3.png`
- `assets/method-4.png`
- `assets/open-finance-lockup.svg`
- `assets/open-finance-logo-option-1-temple-treasury.svg`
- `assets/open-finance-logo-option-2-ionic-ledger.svg`
- `assets/open-finance-logo-option-3-owl-drachma.svg`
- `assets/open-finance-logo-option-4-meander-monogram.svg`
- `assets/open-finance-logo-option-5-marble-tablet.svg`
- `assets/open-finance-logo-sheet.svg`
- `assets/open-finance-mark.svg`
